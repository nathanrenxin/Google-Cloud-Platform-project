...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="Runner" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" project.id2210.project_id2210.Runner %CMD_LINE_ARGS%
